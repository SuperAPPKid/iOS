...
class RollerLayout: UICollectionViewLayout, BothSideScrollable {
    var size: CGSize?
    ...
    var fixBound: BothSideFixBound {
        return .Vertical(lowerBound: CGFloat(0), upperBound: (_contentHeight - _collectionViewBounds.height))
    }
    ...
    override func prepare() {
        ...
        _contentHeight =  .pi * 2.0 * _radius * roteRate + collectionView.bounds.height
    }
    ...
    override func layoutAttributesForItem(at indexPath: IndexPath) -> UICollectionViewLayoutAttributes? {
        ...
        let fixAngle = .twoPi * _collectionViewBounds.minY / (_contentHeight - _collectionViewBounds.height)
